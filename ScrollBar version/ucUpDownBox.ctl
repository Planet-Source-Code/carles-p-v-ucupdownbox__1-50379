...
Private Sub UserControl_Resize()
    ...
    '-- Adjust width
    If (ScaleWidth < 2 * ucBar.Width) Then Width = (2 * ucBar.Width + (Width \ Screen.TwipsPerPixelX - ScaleWidth)) * Screen.TwipsPerPixelX
    
    '-- Adjust height
    Height = ((TextHeight("") + 4) + (Height \ Screen.TwipsPerPixelY - ScaleHeight)) * Screen.TwipsPerPixelY
    
    '-- Relocate controls
    txtValue.Move 1, 1, ScaleWidth - ucBar.Width - 1, ScaleHeight
    ucBar.Move txtValue.Width + 1, 0, ucBar.Width, ScaleHeight
End Sub
